// Un númerp es primo cuando sólo es divisible entre 1 y si mismo
// por ejemplo el 7, el 19, 23

// el 7 no se puede divvidr entre 2, ni 3, ni 4, ni 5, ni 6...
// solo en 1 y 7
...
// si completamos el bloque y en ningún momento se ha cumplido la condición del if, entonces podemos decir que el número es primo
}
    
let mensaje = "";

if (primo) {mensaje = "El número eleido es primo"}
